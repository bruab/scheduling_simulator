...
fh.write("</AS>\n</platform>\n")
fh.close()
print >> sys.stderr, "One-host XML platform file created"
...
fh.write("host-0\n")
fh.close()
print >> sys.stderr, "One-host hostfile created"
...
while (True):
	...
	print "rp="+str(("%.3f" % attempt))+"\t-->  wctime = "+str(("%.3f" % simulated_wallclock))+" (target ="+str(("%.3f" % target))+")"
